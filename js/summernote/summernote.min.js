...
!
    function(a) {
        ...
        var Renderer = function(a, b, c, d) {
            ...
            button = renderer.create('<button type="button" class="note-btn btn1 btn-default btn-sm" tabindex="-1">',
                function(a, b) {
                    b && b.tooltip && a.attr({
                        title: b.tooltip
                    }).tooltip({
            ...
            $.extend($.summernote.lang, {
                "en-US": {
                    ...
                    video: {
                        ...
                        insert: "插入视频",
                        url: "视频地址",
                        providers: "(YouTube, Vimeo, Vine, Instagram, DailyMotion or Youku)支持链接"
                    },
                    link: {
                        link: "链接",
                        insert: "插入链接",
                                ...
                                function() {
                                    return c.buttonGroup({
                                        ...
                                        children: [c.button({
                                            ...
                                            items: ["<li>", '<div class="btn-group">', '  <div class="note-palette-title">' + f.color.background + "</div>", "  <div>", '    <button type="button" class="note-color-reset btn1 btn-default" data-event="backColor" data-value="inherit">', f.color.transparent, "    </button>", "  </div>", '  <div class="note-holder" data-event="backColor"/>', "</div>", '<div class="btn-group">', '  <div class="note-palette-title">' + f.color.foreground + "</div>", "  <div>", '    <button type="button" class="note-color-reset btn1 btn-default" data-event="removeFormat" data-value="foreColor">', f.color.resetToDefault, "    </button>", "  </div>", '  <div class="note-holder" data-event="foreColor"/>', "</div>", "</li>"].join(""),
                                            callback: function(a) {
            ...
            LinkDialog = function(a) {
                ...
                this.initialize = function() {
                    var a = e.dialogsInBody ? $(document.body) : d,
                        b = '<div class="form-group row-link"><label>' + f.link.textToDisplay + '</label><input class="note-link-text form-control" type="text" /></div><div class="form-group row-link"><label class="row-link">' + f.link.url + '</label><input class="note-link-url form-control" type="text" value="http://" /></div>' + (e.disableLinkTarget ? "": '<div class="checkbox row-link"><label><input type="checkbox" checked> ' + f.link.openInNewWindow + "</label></div>"),
                        g = '<button href="#" class="btn1 btn-primary note-link-btn disabled" disabled>' + f.link.insert + "</button>";
            ...
            ImageDialog = function(a) {
                ...
                this.initialize = function() {
                    ...
                    var i = '<div class="form-group note-group-select-from-files"><label>' + f.image.selectFromFiles + '</label><input class="note-image-input form-control" type="file" name="files" accept="image/*" multiple="multiple" />' + b + '</div><div class="form-group note-group-image-url" style="overflow:auto;"><label>' + f.image.url + '</label><input class="note-image-url form-control col-md-12" type="text" /></div>',
                        j = '<button href="#" class="btn1 btn-primary note-image-btn disabled" disabled>' + f.image.insert + "</button>";
                    this.$dialog = c.dialog({
            ...
            VideoDialog = function(a) {
                ...
                this.initialize = function() {
                    var a = e.dialogsInBody ? $(document.body) : d,
                        ...
                        g = '<button href="#" class="btn1 btn-primary note-video-btn disabled" disabled>' + f.video.insert + "</button>";
                    this.$dialog = c.dialog({
